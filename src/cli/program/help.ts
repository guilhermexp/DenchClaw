...
const EXAMPLES = [
  ["hermes start --web-port 3010", "Start the managed web runtime without replacing assets."],
  ["openclaw update", "Refresh the managed web runtime and enforce major upgrade gates."],
  ["hermes stop --web-port 3010", "Stop only the managed web runtime on a specific port."],
